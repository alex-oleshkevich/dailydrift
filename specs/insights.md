...
>
> **Depends on:** [constitution](constitution.md), [data-model](data-model.md), [glossary](glossary.md)   ·   **Related:** [signals](signals.md), [evidence](evidence.md), [narrative](narrative.md), [memory](memory.md), [situations](situations.md), [conversation](conversation.md), [proactivity](proactivity.md)
...
- **Not surface layout.** Where Insights render (Home, chat, Digest) is owned by [conversation](conversation.md) and the client surface (out of scope here); this spec defines *when* and *whether* they surface.
...
> | **Home — "what the System thinks you should know"** | a few high-relevance Insights for the current Space | client (out of scope) |
> | **Digest** | periodic roll-up of the period's most salient Insights | client (out of scope) |
>
...
- [conversation](conversation.md) and the client surface (out of scope here) — the surfaces that render Insights. [proactivity](proactivity.md) — the relevance/urgency bar.
