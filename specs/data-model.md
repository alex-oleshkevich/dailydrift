...
>
> **Depends on:** [constitution](constitution.md)   ·   **Related:** [glossary](glossary.md), [spaces](spaces.md), [signals](signals.md), [insights](insights.md), [memory](memory.md), [entities](entities.md)
...
- **Not the surfacing UI.** Where these appear is owned by [conversation](conversation.md) and the client surface (out of scope here).
